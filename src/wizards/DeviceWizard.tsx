        ...
        <SciFiPanel>
          <div className="p-6">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-cyan-300 neon-text mb-2">
                Add New Device
              </h2>
                ...
                >
                  {step === 0 && (
                    <input
                      ...
                      className="w-full px-4 py-3 bg-black/50 border-2 border-cyan-500/50 rounded-lg text-white"
                    />
                  )}
                  {step === 1 && (
                    ...
                    <div className="glass-strong p-6 rounded-lg">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <span className="text-white ml-2">{deviceName}</span>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <span className="text-white ml-2">
                            {protocols.find((p) => p.value === protocol)?.label}
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex justify-between mt-8">
              ...
              <NeonButton
                onClick={handleNext}
                color={step === steps.length - 1 ? 'green' : 'cyan'}
              >
                {step === steps.length - 1 ? (
                  <>
